# Практическая работа — часть 1 (день 1)

Домашнее / аудиторное задание по темам **l1–l7** (установка, `psql`, конфигурация, MVCC, VACUUM, буферы и WAL) и частично по организации данных.
